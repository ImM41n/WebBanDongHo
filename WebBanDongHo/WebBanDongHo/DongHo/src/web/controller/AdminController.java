...
//					}
	...
	public boolean sendMail(String mailClient, int id, String name, int quantity, float total) {//mail xac nhan thanh toan
		boolean check = true;
	...
	public void saveImage(MultipartFile image) {
		try {
			image.transferTo(new File(
					"C:\\Users\\Admin\\Desktop\\WebBanDongHo\\WebBanDongHo\\WebBanDongHo\\DongHo\\WebContent\\img"
