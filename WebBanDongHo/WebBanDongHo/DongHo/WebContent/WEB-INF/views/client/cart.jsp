			        	...
			        	<div class="infor" style="font-weight: bold;">
						  ...
						  <!--   <label id="lb" style="display: none;">Số lượng:</label> -->
							<c:if test="${o.detail == 'N'}">
								<input style="margin-left: 20px;padding: 10px; border-radius: 5px; border: 1px solid black;" id="sl" type="number" name="amount_o" min="1" value="${o.amount_o}"/>
				            ...
				            <span style="background: rgba(255,0,0,0.8); border-radius: 5px;">${o.status}</span>
