...
<head>
<meta charset="utf-8">
<title>Túi xinh | Thông tin sản phẩm</title>
<base href="${pageContext.servletContext.contextPath}/">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="X-UA-Compatible" content="ie=edge">
    <style><%@include file="/WEB-INF/resources/css/show_prod.css"%></style>
...
<div class="show-prod">
	<form:form action="" >
        <div class="more d-flex">
            <div class="div">
		        <img id="img" src="img/${prod.img1}" alt="">
		        <div class="gom">
		            <img src="img/${prod.img1}" alt="">
		            <img src="img/${prod.img2}" alt="">
		            <img src="img/${prod.img3}" alt="">
		        </div>
		    </div>
            <div class="infor">
                ...
                <p style="line-height: 28px; letter-spacing: 1px">${prod.des}</p>
                <label>Số lượng</label>
                <br>
                
                <input type="number" name="amount_o" min="1" max="${prod.totalNum}" value="1"/>
                
                
                <br>
                <button name="add-to-cart">Thêm vào giỏ hàng<i class="fa fa-cart-arrow-down"></i></button>
                <button name="buy-now">Mua ngay</button>
                ${message }
